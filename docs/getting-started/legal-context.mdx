---
title: Legal Context
description: Learn when a cookie banner is required, how valid consent is obtained, and which legal requirements apply under GDPR, ePrivacy law, and the TDDDG.
---
...
<Callout type="info" title="Contextual consent">
...
Because such services often involve the processing of personal data, users may only access them after giving consent. 

Contextual consent helps users better understand the specific purpose of the processing and allows risks to be communicated in a more intuitive and situation-specific way.
</Callout>

<Callout type="info" title="Opt-out instead of opt-in">
