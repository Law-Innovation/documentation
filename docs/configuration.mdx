...
This page explains how to configure your cookie banner in the Consent Manager to provide your website visitors with an accurate and transparent overview of your data processing activities, enabling them to give informed consent.
...
If you transmit data to the service provider on the basis of a data processing agreement, which limits the service provider to your own processing purposes, select **“processer”**.
...
If the service provider has specified a maximum timeframe, after which any personal data is erased or fully anonymised, indicated this time frame (e.g. 6 months).
...
2. **Add Consenter attributes to your embed**
   ...
   - **For type 2 (additional purposes)**
     ...
     <Callout type="info">
       ...
       <a href="/configuration">TPP configuration guides</a> or the privacy
...
<Callout type="info">
  ...
  check out our <a href="/configuration">TPP configuration guides</a> or refer
