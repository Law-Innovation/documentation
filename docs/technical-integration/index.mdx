...
For some purposes, it is better to also allow your users to provide consent via contextual consent. This applies in particular to additional website features, such as maps, videos or social media feeds, which you want to integrate into your website and which process your end users' data. <a href="/configuration/contextual-consent">See contextual consent guide →</a>
