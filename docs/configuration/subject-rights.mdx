...
description: Review compliance requirements, preview and publish your banner.
---
...
If the banner code has not yet been integrated into your website, the banner will only be deployed once the [technical implementation](/technical-integration/banner-integration) has been completed.
